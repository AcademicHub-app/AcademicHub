  ...
  <div class="h-full w-full text-white flex flex-col">
      ...
      <div class="bg-zinc-900 rounded-lg p-6 w-80">
        ...
        <div class="mb-3">
          ...
          <input 
            v-model="newTitle" 
            type="text" 
            class="w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-zinc-800 text-white  rounded-lg" 
          />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-4">
          <label class="block text-gray-300 mb-1">Data</label>
          <input 
            v-model="newDate" 
            type="date" 
            class="w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-white rounded-md" 
          />
        </div>
    ...
    >
      <div class="bg-zinc-900 rounded-lg p-6 w-[90%] max-w-lg">
        <h2 class="text-xl font-semibold mb-4 text-gray-100">Gerenciar Eventos</h2>
        <ul class="space-y-3 max-h-96 overflow-y-auto">
          ...
          >
            <div>
              ...
              <p class="text-sm text-gray-400">Data: {{ event.start }}</p>
            </div>
            <div class="flex gap-2">
              <button @click="editEvent(event)" class="bg-indigo-700 text-white font-medium px-4 py-2 rounded-lg">
                Editar
              </button>
              <button @click="deleteEvent(event)" class="bg-red-700 text-white font-medium px-4 py-2 rounded-lg">
                Deletar
              </button>
            </div>
          </li>
    ...
    >
      <div class="bg-zinc-900 rounded-lg p-6 w-80">
        <h2 class="text-xl font-semibold mb-4 text-gray-100">Confirmar Exclusão</h2>
